          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6 p-0 mb-3">
                ...
                <input name="profile" type="file" accept=".jpg, .jpeg, .png, .webg" class="form-control shadow-none" require>

              </div>
              <div class="col-md-12 p-0 mb-3 ">
                <label class="form-label">Address</label>
                <textarea name="address" class="form-control shadow-none" rows="1" require></textarea>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <form id="forgot-form">
        ...
        <div class="modal-body">
        <span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base">
            Note: A link will be sent to your email yo reset password
          ...
          <button type="submit" class="btn shadow-none p-0 me-2" data-bs-toggle="modal" data-bs-target="#loginModal" data-bs-dismiss="modal"> 
            CANCLE
          </button>
